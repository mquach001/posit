...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\PycharmProjects\posit-test\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\PycharmProjects\posit-test\venv\Scripts\deactivate.nu'
